...
# Name of the first application title
set titleName to "Ionic App"
...
tell application "Safari"
        ...
        repeat until hasClicked or x > (maxWait * 10)
                try
                        tell application "System Events"
                                click menu item titleName of menu 1 of menu item deviceName of menu "Develop" of menu bar item "Develop" of menu bar 1 of application process "Safari"
                        end tell
        ...
        if hasClicked = false then
                display dialog "Unable to connect to " & deviceName & " - make sure that it's working" buttons {"OK"} default button 1
        else
                try
                        tell application "System Events"
